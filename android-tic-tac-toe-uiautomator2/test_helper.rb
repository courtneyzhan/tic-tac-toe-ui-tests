...
module TestHelper
  ...
  def appium_opts
    app_file = File.join(File.dirname(__FILE__), "..", "..", "sample-apps", "android-tic-tac-toe.apk")
    ...
    opts = {
      caps: {
        ...
        app: app_file,
        appPackage: 'com.techsoldev.tictactoegame',
        appActivity: 'com.techsoldev.tictactoegame.OfflineGameMenuActivity'
      },
      appium_lib: {
